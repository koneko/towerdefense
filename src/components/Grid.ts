...
export class Cell extends GridBaseObject {
    ...
    protected draw() {
        ...
        const text = new PIXI.Text({
            ...
            style: new PIXI.TextStyle({
                fill: '#000000aa',
                fontSize: Math.round(0.3 * this.getPixelScalingFactor()),
            }),
        });
...
export class Grid extends GameObject {
    ...
    protected draw() {
        ...
        for (let cell of this.cells) {
            cell.setBounds(cell.column, cell.row, 1, 1);
